...
class JenisCendraWasih extends StatefulWidget {
  @override
  _JenisCendraWasihState createState() => _JenisCendraWasihState();
}

class _JenisCendraWasihState extends State<JenisCendraWasih> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("JENIS ELANG"),
      ),
